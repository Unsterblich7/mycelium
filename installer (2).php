...
namespace {
    ...
    {
        const ARCHIVE_FILENAME   = 'mycelium_76b1a5986b60c09c2579_20240427122355_archive.zip';
        const ARCHIVE_SIZE       = '82117689';
        const INSTALLER_DIR_NAME = 'dup-installer';
        const PACKAGE_HASH       = '76b1a59-27122355';
        const SECONDARY_PACKAGE_HASH = 'e969aed-27122355';
        const VERSION            = '1.5.9';
